 ...
 */
function subgarland_preprocess_maintenance_page(&$variables) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // subgarland_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  subgarland_preprocess_html($variables);
}

/**
 * Override or insert variables into the html template.
 */
function subgarland_preprocess_html(&$variables) {
 ...
 * Override or insert variables into the html template.
 */
function subgarland_process_html(&$variables) {
 ...
 */
function subgarland_preprocess_page(&$variables) {
 ...
 */
function subgarland_preprocess_node(&$variables) {
 ...
 */
function subgarland_preprocess_comment(&$variables) {
 ...
 */
function subgarland_preprocess_block(&$variables) {
 ...
 * Override or insert variables into the page template.
 */
function subgarland_process_page(&$variables) {
  // Hook into color.module
  if (module_exists('color')) {
 ...
 */
function subgarland_preprocess_region(&$variables) {
